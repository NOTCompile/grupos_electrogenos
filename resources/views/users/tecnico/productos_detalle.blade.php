        ...
        @include('menu_tecnico')
          ...
          <div class="col-md-9">
            <div class="container border shadow p-4">
                 <div class="row">
                  <h3 style="text-decoration:underline; text-align:center"><b>Detalles de {{ $equipo_t->nombre }}</b></h3>
                    </div>
                    <p></p>
                 <div class="row">
                   <div class="col-md-12">                   
                      ...
                      <div class="carousel-inner">    
                        <div class="carousel-item active border">
                          <img class="d-block img-fluid w-100 bg-dark" style="width:200px;height:400px;" src="{{url('https://www.unimaq.com.pe/wp-content/uploads/2019/06/encapsulado-9-5_2.jpg?$cc-s$')}}" alt="">
                           ...
                           @foreach ($equipo_t->image as $item)                         
                 ...
                 <div class="container">
                  ...
                  <div class="row">
                    <div class="col-md-3 border">
                      <h6 class="lead text-center">{{ $equipo_t->user_id }}</h6>
                    </div>
                    <div class="col-md-6 border">
                      <h6 class="lead text-center">{{ $equipo_t->nombre }}</h6>
                    </div>
                    <div class="col-md-3 border">
                      <h6 class="lead text-center">{{ $equipo_t->nombre }}</h6>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-4 border">
                      <h6 class="lead text-center">{{ $equipo_t->empresa }}</h6>
                    </div>
                    <div class="col-md-3 border">
                      <h6 class="lead text-center">{{ $equipo_t->celular }}</h6>
                    </div>
                    <div class="col-md-5 border">
                      <h6 class="lead text-center">{{ $equipo_t->periocidad }}</h6>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-12 border">
                      <h6 class="lead text-left">{{ $equipo_t->ubicacion }}</h6>
                    </div>
                  </div>
                  <P> </P>
                  ...
                  <div class="row">
                    <div class="col-md-3 border">
                      <h6 class="lead text-center">{{ $equipo_t->marca_motor }}</h6>
                    </div>
                    <div class="col-md-3 border">
                      <h6 class="lead text-center">{{ $equipo_t->modelo_motor }}</h6>
                    </div>
                    <div class="col-md-3 border">
                      <h6 class="lead text-center">{{ $equipo_t->marca_generador }}</h6>
                    </div>
                    <div class="col-md-3 border">
                      <h6 class="lead text-center">{{ $equipo_t->modelo_generador }}</h6>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-3 border bg-danger text-white">
                  ...
                  <div class="row">
                    <div class="col-md-3 border">
                      <h6 class="lead text-center">{{ $equipo_t->nserie_motor }}</h6>
                    </div>
                    <div class="col-md-3 border">
                      <h6 class="lead text-center">{{ $equipo_t->potencia_motor }}</h6>
                    </div>
                    <div class="col-md-3 border">
                      <h6 class="lead text-center">{{ $equipo_t->nserie_generador }}</h6>
                    </div>
                    <div class="col-md-3 border">
                      <h6 class="lead text-center">{{ $equipo_t->potencia_generador }}</h6>
                    </div>
                  </div>
                  <P></P>
