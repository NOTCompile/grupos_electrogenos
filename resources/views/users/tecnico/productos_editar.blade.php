    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-9 border shadow p-4">            
            ...
            <form action="{{ route('producto_actualizar_t', $equipo_t_e->id) }}" method="POST" enctype="multipart/form-data" id="upload">
              ...
              <div class="form-row bg-warning">
                ...
                <select name="user_id" id="inputState" class="form-control">
                    <option selected disabled value="">{{ $equipo_t_e->user_id  }}</option>   
            ...
            <div class="form-row bg-warning">
                    <div class="form-group col-md-7 text-lg-center">
                        <label>Empresa</label>
                        <input type="text" name="empresa" class="form-control" value="{{ $equipo_t_e->empresa }}">
                    </div>
                    <div class="form-group col-md-2 text-lg-center">
                        <label>Periocidad</label>
                        <select name="periocidad" id="inputState" class="form-control">
                            <option selected disabled value="">{{ $equipo_t_e->periocidad  }}</option>
            ...
            <div class="form-row bg-warning">
                <div class="form-group col-md-3 text-lg-center">
                    <label>Marca</label>
                    <input type="text" name="marca_motor" id="" value="{{  $equipo_t_e->marca_motor  }}" class="form-control">
                </div>
                <div class="form-group col-md-3 text-lg-center">
                    <label>Modelo</label>
                    <input type="text" name="modelo_motor" id="" value="{{  $equipo_t_e->modelo_motor  }}" class="form-control">
                </div>
                <div class="form-group col-md-3 text-lg-center">
                    <label>Marca</label>
                    <input type="text" name="marca_generador" id="" value="{{  $equipo_t_e->marca_generador  }}" class="form-control">
                </div>
                <div class="form-group col-md-3 text-lg-center">
                    <label>Modelo</label>
                    <input type="text" name="modelo_generador" id="" value="{{  $equipo_t_e->modelo_generador  }}" class="form-control">
                </div>
            </div>   
                <div class="form-row bg-warning">
                    <div class="form-group col-md-3 text-lg-center">
                        <label>N° Serie</label>
                        <input type="text" name="nserie_motor" id="" value="{{  $equipo_t_e->nserie_motor  }}" class="form-control">
                    </div>
                    <div class="form-group col-md-3 text-lg-center">
                        <label>Potencia</label>
                        <input type="text" name="potencia_motor" id="" value="{{  $equipo_t_e->potencia_motor  }}" class="form-control">
                    </div>
                    <div class="form-group col-md-3 text-lg-center">
                        <label>N° Serie</label>
                        <input type="text" name="nserie_generador" id="" value="{{  $equipo_t_e->nserie_generador  }}" class="form-control">
                    </div>
                    <div class="form-group col-md-3 text-lg-center">
                        <label>Potencia</label>
                        <input type="text" name="potencia_generador" id="" value="{{  $equipo_t_e->potencia_generador  }}" class="form-control">
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-12 bg-danger text-white">
                ...
                <div class="form-row bg-warning text-lg-center">
                    <div class="form-group col-md-4">
                        <label>Fecha</label>
                        <input type="date" name="fecha" class="form-control" value="{{  $equipo_t_e->fecha  }}">
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <a href="{{ route('inicio_imagenes_t') }}" class="btn btn-outline-primary"><i class="fa fa-plus-circle"></i> Imagenes</a>
                    </div>
                </div>
                             <p></p>  
              <div class="form-row">
