     ...
     <div class="row justify-content-center">
         @include('menu_administrador')
          <div class="col-md-9 border shadow p-4">
               <a href="{{ route('imagenes_agregar_a') }}" class="btn btn-outline-primary"><i class="fa fa-plus"></i> Nueva Imagen</a>
               <p></p> 
                              ...
                              @foreach ($image_a as $item)
                                  <tr class="table-info">
                                       ...
                                       <td class="border text-center border-dark">
                                        <div> 
                                             <form action="{{ route('imagenes_eliminar_a', $item) }}" method="POST" class="d-inline">
                                             @method('DELETE')
                                             @csrf
