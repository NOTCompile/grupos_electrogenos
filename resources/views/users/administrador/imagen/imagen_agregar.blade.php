         ...
         @include('menu_administrador')
          <div class="col-md-9 border shadow p-4">
               <div class="form-row">
                ...
                <form action="{{ route('imagenes_crear_a') }}" method="POST" enctype="multipart/form-data" id="upload">
                  @csrf
                  @error('codigo')
                  ...
                  @enderror
                    ...
                    <div class="form-row">
                         <div class="form-group">
                                 <a class="btn btn-outline-primary" href="{{ route('inicio_imagenes_a') }}"><i class="fa fa-arrow-circle-o-left"></i>&nbsp;Volver </a>
